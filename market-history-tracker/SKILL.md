---
name: market-history-tracker
description: Track completed orders (TP/SL) per asset in separate monthly .md history files. Bold entries, plain title. Send as clickable file attachment.
---
...
2. Run helper script:
   `python ~/.hermes/skills/research/market-history-tracker/scripts/add_history.py {ASSET} {ANALYST_NUM} {DIRECTION} {RESULT} {PIPS}`
